      ...
      <div className="bg-[#eeeeee] min-h-screen p-6 grid place-items-center w-full">
        <div className="w-full bg-white rounded-lg shadow-lg p-10 mt-6 md:w-4/6">
          <p className="text-sm font-normal text-gray-500 text-left">
            Thank you for expressing interest in Travel yatri. Your Profile is
            under admin verification Please wait sometime.
          </p>
          <div className="flex gap-4 flex-wrap w-full justify-center mt-6">
            <Link
              href={"/"}
