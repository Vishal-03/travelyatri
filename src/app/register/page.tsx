    ...
    return (
        <div className="bg-gray-100 flex items-center justify-center h-screen">
            ...
            <div className="bg-white p-8 rounded-lg shadow-lg max-w-sm w-full">
                ...
                <div>
                    <div className="mb-4">
                        <label htmlFor="fullName" className="block text-gray-700 text-sm font-semibold mb-2">Username</label>
                        <div>
                            <input type="text" name="username" id="username" className="form-input w-full px-4 py-2 border rounded-lg text-gray-700 focus:ring-blue-500" required placeholder="Username" onChange={handleChange} value={registerForm.username} />
                        </div>
                    </div>
                    <div className="mb-4">
                    ...
                    <div>
                        <input type="hidden" name="type" value={userType ? "AGENCY" : "USER"} />
                    </div>

                    <button onClick={registerUser} disabled={mutation.isPending} className="w-full bg-blue-500 text-white px-4 py-2 rounded-lg hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50">Register</button>
