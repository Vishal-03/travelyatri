...
export function Fa6SolidDoorOpen(props: SVGProps<SVGSVGElement>) {
  return (
    ...
    >
      <path
        fill="currentColor"
        d="M320 32c0-9.9-4.5-19.2-12.3-25.2S289.8-1.4 280.2 1L100.3 46C79 51.3 64 70.5 64 92.5V448H32c-17.7 0-32 14.3-32 32s14.3 32 32 32h288v-32zm-64 224c0 17.7-10.7 32-24 32s-24-14.3-24-32s10.7-32 24-32s24 14.3 24 32m96-128h96v352c0 17.7 14.3 32 32 32h64c17.7 0 32-14.3 32-32s-14.3-32-32-32h-32V128c0-35.3-28.7-64-64-64h-96z"
      ></path>
    </svg>
  );
}
...
export function MaterialSymbolsContactEmergency(
  ...
  return (
    ...
    >
      <path
        fill="currentColor"
        d="M17.25 12h1.5v-1.7l1.475.85l.75-1.3L19.5 9l1.475-.85l-.75-1.3l-1.475.85V6h-1.5v1.7l-1.475-.85l-.75 1.3L16.5 9l-1.475.85l.75 1.3l1.475-.85zM2 21q-.825 0-1.412-.587T0 19V5q0-.825.588-1.412T2 3h20q.825 0 1.413.588T24 5v14q0 .825-.587 1.413T22 21zm7-7q1.25 0 2.125-.875T12 11q0-1.25-.875-2.125T9 8q-1.25 0-2.125.875T6 11q0 1.25.875 2.125T9 14m-6.9 5h13.8q-1.05-1.875-2.9-2.937T9 15q-2.15 0-4 1.063T2.1 19"
      ></path>
    </svg>
  );
}

export function MaterialSymbolsVisibilityRounded(
  props: SVGProps<SVGSVGElement>
) {
  return (
    <svg
...
export function MaterialSymbolsVisibilityOffRounded(
  props: SVGProps<SVGSVGElement>
) {
  return (
    <svg
...
export function GridiconsMenu(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="1em"
      ...
      {...props}
    >
      <path fill="#888888" d="M21 6v2H3V6zM3 18h18v-2H3zm0-5h18v-2H3z"></path>
    </svg>
  );
}

export function IcBaselineContactPage(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="1em"
...
export function FaRegularCheckCircle(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="1em"
...
export function FaSolidTrashAlt(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="0.88em"
