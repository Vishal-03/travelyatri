    ...
    return (
        ...
        <>
            <div className="w-60 h-screen fixed bg-rose-500 flex py-6 flex-col gap-2">
                ...
                <h1 className="text-center text-sm text-white font-medium">AGENCY</h1>
                ...
                <Link href={"/dashboard/search"} className={`flex py-1 px-4 gap-4 items-center ${pathname == "/dashboard/search" ? "rounded-l-full text-rose-500 bg-white ml-4" : "rounded-md text-white mx-4"}`}><Fa6SolidMagnifyingGlass /> <p>Search</p></Link>
                <Link href={"/dashboard/query"} className={`flex py-1 px-4 gap-4 items-center ${pathname == "/dashboard/query" ? "rounded-l-full text-rose-500 bg-white ml-4" : "rounded-md text-white mx-4"}`}><Fa6SolidCircleQuestion /> <p>Query</p></Link>
