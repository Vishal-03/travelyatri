import { Input, email, maxLength, minLength, minValue, number, object, string } from "valibot";

const createAgencySchema = object({
    userId: number([
        minValue(1, 'Please enter the user id.'),
    ]),
    name: string([
        minLength(1, 'Please enter your agency name.'),
    ]),
    website: string([
        minLength(1, 'Please enter your agency website address.'),
    ]),
    contact: string([
    ...
    address: string([
        minLength(1, 'Please enter your agency address.'),
    ]),
    description: string([
        minLength(1, 'Please enter your agency description.'),
    ]),
});
